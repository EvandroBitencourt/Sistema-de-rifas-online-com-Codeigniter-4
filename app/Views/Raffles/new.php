        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" required class="form-control" name="title" placeholder="Título" value="<?php echo old('title', $raffle->title); ?>">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="price">Preço de cada número (bilhete)</label>
                    <input type="text" required class="form-control money" name="price" placeholder="Preço"
                        value="<?php echo old('price', $raffle->price); ?>">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="total_tickets">Total de números que serão gerados</label>
                    <input type="number" required class="form-control" min="1" name="total_tickets" placeholder="Total de números"
                        value="<?php echo old('total_tickets', $raffle->total_tickets); ?>">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="draw_date">Data do sorteio</label>
                    <input type="date" required class="form-control" name="draw_date" placeholder="Data do sorteio"
                        value="<?php echo old('draw_date', $raffle->draw_date); ?>">
                </div>

                <div class="col-md-12 mb-3">
                    <label for="description">Descrição</label>
                    <textarea name="description" class="form-control" id="description"
                        placeholder="Descrição" required><?php echo old('description', $raffle->description); ?></textarea>
                </div>
